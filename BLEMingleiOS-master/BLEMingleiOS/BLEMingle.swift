...
class BLEMingle: NSObject, CBPeripheralManagerDelegate, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    func peripheral(_ peripheral: CBPeripheral, didUpdateValueFor characteristic: CBCharacteristic, error: Error?) {
        ...
        if (stringFromData! == "EOM") {
            print("Data Received: \(String(describing: NSString(data: data as Data, encoding: String.Encoding.utf8.rawValue)))")
            data.length = 0
    ...
    func StringToUUID(hex: String) -> String
    {
        ...
        print(rev.characters)
        print(rev.characters.count)
    ...
    private func peripheralManager(peripheral: CBPeripheralManager, central: CBCentral, didUnsubscribeFromCharacteristic characteristic: CBCharacteristic) {
    ...
    func transferData() {
        if sendingEOM {
            ...
            let didSend:Bool = peripheralManager.updateValue("EOM".data(using: String.Encoding.utf8)!, for: transferCharacteristic, onSubscribedCentrals: nil)
        ...
        while(didSend) {
            ...
            let stringFromData = NSString(data: chunk as Data, encoding: String.Encoding.utf8.rawValue)
    ...
    private func peripheralManagerIsReadyToUpdateSubscribers(peripheral: CBPeripheralManager) {
